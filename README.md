...
- [OPay Business](https://play.google.com/store/apps/details?id=team.opay.pay.merchant.service) --- a financial & payment app (2 millions of users daily). OPay uses Kea2 for regression testing on POS machines and mobile devices.
